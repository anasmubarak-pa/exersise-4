...
let input6 = ["user@domain"]
let ouput6 = false
let input7 = ['hi']
let ouput7 = false
let input8 = ["name.name@id.com"]
let ouput8 = true
let input9 = [{a:1,b:2}]
...
testProgram(verifyEmail,[input1,input2,input3,input4,input5,input6,input7,input8,input9,input10,
